...
// LogRecords for entity events (by the otel.entity.event.type attribute),
// converts them into change-engine observations, and hands them off. Non-entity
// LogRecords are ignored. Toise implements no collectors of its own; producers
